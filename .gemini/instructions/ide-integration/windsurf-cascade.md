...
1. Load role definition from `.gemini/instructions/roles/[role].md`
2. Execute according to role responsibilities
3. Create artifacts in `docs/sprints/sprint-[N]/`
4. Follow global rules from `.gemini/instructions/global.md`
...
- Knowledge base in `.gemini/instructions/knowledge-base/`
- Global rules in `.gemini/instructions/global.md`
...
```json
{
  "customCommands": {
    "pm": {
      ...
      "action": "loadRole",
      "rolePath": ".gemini/instructions/roles/pm.md"
    },
    "orchestrator": {
      "description": "Workflow Automation",
      "action": "loadRole",
      "rolePath": ".gemini/instructions/roles/orchestrator.md"
    },
    "auto": {
